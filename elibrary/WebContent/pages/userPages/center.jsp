...
<body>
  <div class="header_bg">
    <div id="header">
      ...
      <div id="hd_banner"><span>AKUN图书借阅服务平台</span></div>
      <div style="position:absolute; bottom:2px; right:8px">
        ...
        <span style="color:white">欢迎，工作人员：<%=userInfo.getUsername()%>！</span><a style="color:lightblue" href="<%=request.getContextPath()%>/logout.action">注销</a>
      </div>
    </div>
  </div>
  <div class="navi_bg">
  ...
  <div class="container_bg">
    <div id="container">
      <div id="sidebar">
        <ul>
          <li>
            <a href="javascript:void(0)">借阅操作</a>
            <ul>
              <li>
            <a href="<%=request.getContextPath()%>/pages/userPages/borrowInfo.jsp">图书借阅</a>
          </li>
          <li>
            <a href="<%=request.getContextPath()%>/pages/userPages/returnBorrowInfo.jsp">图书归还</a>
          </li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul>
              ...
              <li><a href="<%=request.getContextPath()%>/pages/userPages/literatureList.jsp">图书列表</a></li>
            </ul>
          </li>
          <li>
